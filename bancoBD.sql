...
cpf_cliente char(15) PRIMARY KEY,
num_conta char(7) NOT NULL,
data_inicio Date,
CONSTRAINT fk_cpfCliente FOREIGN KEY (cpf_cliente) REFERENCES Cliente(cpf) ON UPDATE CASCADE ON DELETE CASCADE,
CONSTRAINT fk_numConta FOREIGN KEY (num_conta) REFERENCES Conta(numero_conta) ON UPDATE CASCADE ON DELETE CASCADE
);

CREATE TABLE Telefone (
cpf_cli char(15) PRIMARY KEY,
...
INSERT INTO Historico VALUES ("111.222.333-44", "11765-2", "2015-12-22");
INSERT INTO Historico VALUES ("666.777.888-99", "11765-2", "2016-10-25");
